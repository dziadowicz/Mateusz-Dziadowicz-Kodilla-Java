...
public class BoardTestSuite {
    ...
    void testAddTaskListAverageWorkingOnTask() {
        ...
        double averageTaskTime = IntStream.range(0, tasks.size())
                .map(n -> (int) LocalDate.now().toEpochDay() - (int) (tasks.get(n).getCreated().toEpochDay()))
                .average().getAsDouble();

        //Then
        assertEquals(10, averageTaskTime);
    }
